...
class DefaultApi
{
    ...
    public function __construct(\Swagger\Client\ApiClient $apiClient = null)
    {
        if ($apiClient === null) {
            ...
            $apiClient->getConfig()->setHost('https://virtserver.swaggerhub.com/JTL-API/JTL-Article-Data/0.0.1');
        }
    ...
    {
        list($response) = $this->articleGetWithHttpInfo();
        return $response;
    }
     ...
     */
    public function articleGetWithHttpInfo()
    {
        // parse inputs
     ...
     * 
     *
     * @param string $id the id of the article (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\InlineResponse2001
     */
    public function dataRequest($id)
    {
        list($response) = $this->dataRequestWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation dataRequestWithHttpInfo
     *
     * 
     *
     * @param string $id the id of the article (required)
     ...
     */
    public function dataRequestWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling dataRequest');
        }
        // parse inputs
        $resourcePath = "/article/{id}/data_request";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
